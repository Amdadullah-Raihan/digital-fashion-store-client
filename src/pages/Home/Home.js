...
const Home = () => {
  ...
  useEffect(() => {
    setIsLoading(true)
    fetch(`https://digital-fashion-store-server.vercel.app/products?category=${catagory}&&color=${color}&&pattern=${patttern}`)
      .then(res => res.json())
      .then(products => {
    ...
    <div className=''>
      <div className="drawer drawer-mobile">
        ...
        <div className="drawer-content ">
          ...
          <ProductsContainer products={filteredProducts} isLoading={isLoading} setIsLoading={setIsLoading} />
